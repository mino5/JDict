 ...
 */
public class SchoolGradesLogic extends BrowseLogic {

    public SchoolGradesLogic() {

        mCurrentActionBarTitle = "School Grades";
        mType = BrowseType.School;
    }

    protected void initResources() {

        mNameArray = mActivity.getResources().getStringArray(R.array.GradeItems);
        mDescriptionArray = mActivity.getResources().getStringArray(R.array.GradeDescriptions);
        mCounts = mActivity.getResources().getStringArray(R.array.GradeCounts);
        mIconTexts = mActivity.getResources().getStringArray(R.array.GradeIconTexts);
        mActionBarTitles = mActivity.getResources().getStringArray(R.array.GradeActionBarHeaders);
    }
    ...
    private class LoadKanji extends AsyncTask<Integer, Void, ArrayList<BrowseObject>> {
        ...
        protected ArrayList<BrowseObject> doInBackground(Integer... params) {
            ...
            Cursor cursorKanji = db.getKanji().getKanjiDetailSchoolGrade((Integer) params[0]);
