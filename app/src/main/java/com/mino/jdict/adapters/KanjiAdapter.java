...
public class KanjiAdapter extends ArrayAdapter<ASearchObject> {
    ...
    */
    public KanjiAdapter(Context context, int textViewResourceId, ArrayList<ASearchObject> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        KanjiObject i = (KanjiObject) objects.get(position);
        ...
        if (i != null) {
            ...
            if (i.Detail.get() != null) {
                ...
                AdapterHelper.DecompositionItem(i.Detail.get(), inflater, kanji, kanjiMeaning, kanjiReading, showKanji, v);
                ...
                moreResultsText.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        assert ((SearchLogic) Logic.get(((KanjiActivity) context))) != null;
                        ((SearchLogic) Logic.get(((KanjiActivity) context))).getMoreAdditionalResults(pos);
                    }
                });
    ...
    public static class KanjiAdapterFactory implements IAdapterFactory<ArrayAdapter<ASearchObject>> {
        public ArrayAdapter<ASearchObject> factory(Context context, int textViewResourceId, ArrayList<?> objects) {
            return new KanjiAdapter(context, textViewResourceId, (ArrayList<ASearchObject>) objects);
        }
    }
