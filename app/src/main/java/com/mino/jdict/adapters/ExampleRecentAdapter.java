...
public class ExampleRecentAdapter extends ArrayAdapter<ARecentObject> {
    ...
    */
    public ExampleRecentAdapter(Context context, int textViewResourceId, ArrayList<ARecentObject> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        ExampleRecentObject i = (ExampleRecentObject) objects.get(position);
            ...
            if (!i.Header.get().isEmpty()) {
                ...
                moreResultsText.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        ...
                        ((SearchLogic) Logic.get(((ExampleActivity) context))).getMoreAdditionalRecentWords();
                    }
                });

            } else {

                v = inflater.inflate(R.layout.list_recent_item_example, null);
    ...
    public static class ExampleRecentFactory implements IAdapterFactory<ArrayAdapter<ARecentObject>> {
        public ArrayAdapter<ARecentObject> factory(Context context, int textViewResourceId, ArrayList<?> objects) {
            return new ExampleRecentAdapter(context, textViewResourceId, (ArrayList<ARecentObject>) objects);
        }
    }
