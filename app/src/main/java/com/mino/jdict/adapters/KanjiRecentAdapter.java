...
public class KanjiRecentAdapter extends ArrayAdapter<ARecentObject> {
    ...
    */
    public KanjiRecentAdapter(Context context, int textViewResourceId, ArrayList<ARecentObject> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        KanjiRecentObject i = (KanjiRecentObject) objects.get(position);
            ...
            if (!i.Header.get().isEmpty()) {
                ...
                moreResultsText.setOnClickListener(new View.OnClickListener() {
                    public void onClick(View v) {
                        assert (Logic.get(((KanjiActivity) context))) != null;
                        ((SearchLogic) Logic.get(((KanjiActivity) context))).getMoreAdditionalRecentWords();
                    }
                });

            } else {

                v = inflater.inflate(R.layout.list_recent_item_kanji, null);
                ...
                if (text != null) {
                    ...
                    //ShowUtils.showKanji(text, i.getKeb());
                }
    ...
    public static class KanjiRecentFactory implements IAdapterFactory<ArrayAdapter<ARecentObject>> {
        public ArrayAdapter<ARecentObject> factory(Context context, int textViewResourceId, ArrayList<?> objects) {
            return new KanjiRecentAdapter(context, textViewResourceId, (ArrayList<ARecentObject>) objects);
        }
    }
