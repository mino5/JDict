...
import com.mino.jdict.MyDownloaderService;
...
public class DownloaderActivity extends Activity implements IDownloaderClient {
    ...
    private static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    23, // the version of the APK that the file was uploaded
                    // against
                    238663680L // the length of the file in bytes
            )
    };
        ...
        AsyncTask<Object, DownloadProgressInfo, Boolean> validationTask = new AsyncTask<Object, DownloadProgressInfo, Boolean>() {
            ...
            protected Boolean doInBackground(Object... params) {
                for (XAPKFile xf : xAPKS) {
                    ...
                    // main to bazka nie jest zipem
                    if (xf.mIsMain) continue;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        boolean filesDelivered = expansionFilesDelivered();
    ...
    public void init() {
        StartupStaticData.Init(getBaseContext());
    }
